...
class AtividadesControllerTest < ActionController::TestCase
  ...
  test "should create atividade" do
    assert_difference('Atividade.count') do
      post :create, atividade: { ativo: @atividade.ativo, indicacao: @atividade.indicacao, instrucao: @atividade.instrucao, nome: @atividade.nome, observacao: @atividade.observacao, restricao: @atividade.restricao, tipo: @atividade.tipo }
    end
  ...
  test "should update atividade" do
    patch :update, id: @atividade, atividade: { ativo: @atividade.ativo, indicacao: @atividade.indicacao, instrucao: @atividade.instrucao, nome: @atividade.nome, observacao: @atividade.observacao, restricao: @atividade.restricao, tipo: @atividade.tipo }
    assert_redirected_to atividade_path(assigns(:atividade))
  end
